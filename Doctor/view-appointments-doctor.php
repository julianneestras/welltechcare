...
<html lang="en">
  <head>
    ...
    <meta
      property="og:title"
      content="ViewAppointments-Doctor - WellTech Care"
    />
  ...
  <body>
    <div>
      <link href="./view-appointments-doctor.css" rel="stylesheet" />

      <div class="view-appointments-doctor-container">
        <div
          class="view-appointments-doctor-doctor-view-appntnts-body-container"
        >
          <div class="view-appointments-doctor-sidebar">
            <div class="view-appointments-doctor-logo-container">
              <img
                alt="image"
                src="public/playground_assets/logo-200h.png"
                class="view-appointments-doctor-image"
              />

              <div class="view-appointments-doctor-container01">
                <span class="view-appointments-doctor-logo-text">
                  WellTech Care
                </span>
                <span class="view-appointments-doctor-text">
                  Physical &amp; Health Care
                </span>
              </div>
              <svg
                viewBox="0 0 1024 1024"
                class="view-appointments-doctor-icon"
              >
                <path
            ...
            <nav class="view-appointments-doctor-nav">
              <a
                href="doctor-portal-home.php"
                class="view-appointments-doctor-navlink"
              >
                <div class="view-appointments-doctor-container02">
                  <svg
                    viewBox="0 0 1024 1024"
                    class="view-appointments-doctor-icon02"
                  >
                    <path
                  ...
                  <span class="view-appointments-doctor-text01">Dashboard</span>
                </div>
              </a>
              <div class="view-appointments-doctor-container03">
                <a
                  href="view-appointments-doctor.php"
                  class="view-appointments-doctor-navlink1"
                >
                  <div class="view-appointments-doctor-container04">
                    <div class="view-appointments-doctor-container05">
                      <svg
                        viewBox="0 0 950.8571428571428 1024"
                        class="view-appointments-doctor-icon04"
                      >
                        <path
                    ...
                    <span class="view-appointments-doctor-text02">
                      View Appointments
                    </span>
                  </div>
                </a>
              ...
              <a
                ...
                class="view-appointments-doctor-navlink2"
              >
                <div class="view-appointments-doctor-enter-results">
                  <svg
                    viewBox="0 0 1024 1024"
                    class="view-appointments-doctor-icon06"
                  >
                    <path
                  ...
                  <span class="view-appointments-doctor-text03">
              ...
              <a
                ...
                class="view-appointments-doctor-navlink3"
              >
                <div class="view-appointments-doctor-profile">
                  <svg
                    viewBox="0 0 877.7142857142857 1024"
                    class="view-appointments-doctor-icon08"
                  >
                    <path
                  ...
                  <span class="view-appointments-doctor-text06">
                    <span>Profile</span>
                    <br />
                  </span>
                </div>
              ...
              <a
                ...
                class="view-appointments-doctor-navlink4 logout"
              >
                <div class="view-appointments-doctor-logout">
                  <div class="view-appointments-doctor-container06">
                    <svg
                      viewBox="0 0 1024 1024"
                      class="view-appointments-doctor-icon10"
                    >
                      <path
                  ...
                  <div class="view-appointments-doctor-container07">
                    <span class="view-appointments-doctor-text09">
                      <span>Logout</span>
                      <br />
                    </span>
                  </div>
            ...
            <div class="view-appointments-doctor-profile1">
              <?php echo '<img src="data:image;base64,'.base64_encode( $doctor_image ).'"class="view-appointments-doctor-image1"
                         />';?>
              <div class="view-appointments-doctor-container08">
                <span class="view-appointments-doctor-text12">
                 <?php echo $doctor_firstname," ", $doctor_middleinitial," ", $doctor_lastname?>
                </span>
                <span class="view-appointments-doctor-text13">Doctor</span>
              </div>
            </div>
          </div>
          <div class="view-appointments-doctor-main-body-container">
            <div class="view-appointments-doctor-header-container">
              <span class="view-appointments-doctor-patient-portal-txt">
                Doctor Portal System&nbsp;
              </span>
              <div class="view-appointments-doctor-icons-container">
                <img
                  alt="image"
                  src="public/playground_assets/search-200h.png"
                  class="view-appointments-doctor-image2"
                />
                <a
                  href="view-appointments-doctor.php"
                  class="view-appointments-doctor-navlink5"
                >
                  <img
                    alt="image"
                    src="public/playground_assets/plus%20%5B4%5D-200h.png"
                    class="view-appointments-doctor-image3"
                  />
                </a>
                <img
                  alt="image"
                  src="public/playground_assets/bell%20%5B2%5D-200h.png"
                  class="view-appointments-doctor-image4"
                />
              </div>
            </div>
            <div class="view-appointments-doctor-container09">
              <div class="view-appointments-doctor-container10">
                <div class="view-appointments-doctor-container11">
                  <div
                    class="view-appointments-doctor-doctor-view-appntmnts-form-container"
                  >
                    <div class="view-appointments-doctor-container12">
                      <span
                        class="view-appointments-doctor-cnfrm-appointment-txt"
                      >
                        Patient Appointments
                      </span>
                    </div>
                    <form method="POST" action="">
                    <div class="view-appointments-doctor-container13">
                      <input
                        type="text"
                        name="valueToSearch"
                        placeholder="Search here..."
                        class="view-appointments-doctor-textinput input"
                      />
                      <input
                        name="search"
                        type="submit"
                        class="view-appointments-doctor-clear-btn button" style="margin-top: 26px; margin-left: 8px;"
                        value = "Search"
                      >
                    </form>
                        
                    </div>
                    <div class="view-appointments-doctor-html-node">
                      <style>
                      ...
                      <table
                        style="width: 100%;  border: 1px solid #D9D9D9" align="center">
                          <tr>
                            <td>
                              <table
                              ...
                              >
                                ...
                                while ($row = $search_result->fetch_assoc()):
                                  ...
                                  <tr style="border-top: 1px solid #CED5E0;">
                                    <td
                                      width="40%"
                                      style="padding-left: 20px; padding-right: 20px; padding-top: 10px;  padding-bottom: 10px; font-family: 'Lato', sans-serif;"
                                    >
                                      <font
                                    ...
                                    <td width="20%" style="text-align: center">
                                      <font
                                        style="font-family: 'Inter', sans-serif; font-size: 13px; color: #4C5A7A; line-height: 2; letter-spacing: -1px;"
                                      >
                                       <?= $row['appointment_date'], "<br>",$row['appointment_time'] ?>
                                      </font>
                                    </td>
                                    <td width="20%" style="letter-spacing: -1px; text-align: right;">
                                      <font
                                        style="font-size: 13px; color: #4C5A7A; font-family: 'Inter', sans-serif;"
                                      >
                                    ...
                                    >
                                      <a href="appointment-expanded-page-doctor.php?Appointment-ID=<?= $row['appointment_id'] ?>"class="button">
                                        <svg
                                          width="18px"
                                          height="18px"
                                          viewBox="0 0 36 36"
