...
<html lang="en">
  <head>
    ...
    <title>WellTech Care: Physical & Health Care | Home</title>
    <meta property="og:title" content="Noisy Bronze Hornet" />
      ...
      <div class="home-container">
        <div class="home-container01">
          <a href="index.php" class="home-navlink">
            <div class="home-container02">
              ...
              <div class="home-container03">
                <span class="home-logo-text">WellTech Care</span>
                <span class="home-text">Physical &amp; Health Care</span>
              </div>
            </div>
          </a>
          ...
          <div class="home-container04">
            ...
            <span class="home-text004">0935-784-0897</span>
          </div>
          <img
            alt="image"
          ...
          <div class="home-container05">
            <div class="home-container06">
              ...
              <span class="home-text008">Mon-Sun: 9:00am-7:00pm</span>
            </div>
          </div>
          <img
            alt="image"
          ...
          <div class="home-container07">
            ...
            <span class="home-text012">https://www.welltechcare.com/</span>
          </div>
        </div>
        <div class="home-container08">
          <div class="home-container09">
            <header data-role="Header" class="home-header">
              <div class="home-nav">
                <nav
                  class="navigation-links5-nav navigation-links5-root-class-name10"
                >
              ...
              <div class="home-btn-group">
                <a href="Patient/login-patient.php" class="home-login button">
              ...
              <div data-type="MobileMenu" class="home-mobile-menu">
                <div class="home-nav1">
                  ...
                  <nav
                    class="navigation-links5-nav navigation-links5-root-class-name11"
                  >
                    <a href="index.php" class="navigation-links5-navlink">
                      <span>Home</span>
                    </a>
                    ...
                    <a
                      href="contact-us.php"
                      class="navigation-links5-navlink3"
                    >
                      <span>Contact Us</span>
                    </a>
                    <a
              ...
              <div class="home-container14">
                <div class="home-container15">
                  ...
                  <div class="home-container16">
                    <span class="home-logo-text1">WellTech Care</span>
                    <span class="home-text016">Physical &amp; Health Care</span>
                  </div>
                </div>
                <span class="home-text017">
                  <span>In</span>
                  <span class="home-text019">WellTech Care</span>
                  <span class="home-text020">,</span>
                  <span>we change the way you</span>
                  <span>receive</span>
                  <span class="home-text023"></span>
                  <span class="home-text024">healthcare</span>
                  <span class="home-text025">.</span>
                </span>
                <h1 class="home-text026">
                  <span>Exceptional technology. Extraordinary care.</span>
                  <br />
                </h1>
              </div>
            </div>
        ...
        <div class="home-container17">
          <div class="home-features">
            <h1 class="home-text029">
              <span>Explore our services</span>
              <br />
              <span></span>
            </h1>
            <span class="home-text032">
            With Welltech care, we are offering one of the fastest and most trusted PME services someone could find. 
            It’s conducted by several professional doctors ensuring that every data we get from PME will be accurate.
            </span>
            <div class="home-container18">
              <div class="home-container19">
                <div class="home-feature-card">
                  <img
                    alt="image"
                    src="public/playground_assets/charity%20%5B1%5D-300h.png"
                    class="home-image3"
                  />
                  <h2 class="home-text033">Schedule Appointment</h2>
                  <span class="home-text034">
                  Schedule your preferred dates ahead of time so our admins could process your appointments as soon as possible.
                  </span>
                </div>
              </div>
              <div class="home-container20">
                <div class="home-container21">
                  <div class="home-feature-card1">
                    <img
                      alt="image"
                      src="public/playground_assets/handshake-300h.png"
                      class="home-image4"
                    />
                    <h2 class="home-text035">Get Your Treatment</h2>
                    <span class="home-text036">
                    If you feel anything that seems to be not right get your appointment now and get treated by professional doctors. 
                    </span>
                  </div>
                </div>
                <div class="home-container22">
                  <div class="home-feature-card2">
                    <img
                      alt="image"
                      src="public/playground_assets/stethoscope-300h.png"
                      class="home-image5"
                    />
                    <h2 class="home-text037">Find A Doctor</h2>
                    <span class="home-text038">
                    Do you want a specific doctor to perform your PME? Choose among our available doctors.
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div class="home-container25">
              <div class="home-container26">
                <div class="home-container27">
                  <img
                    alt="image"
                    src="public/playground_assets/untitled%20%5B505%20%C3%97%20215%20px%5D-300h.png"
                    class="home-image6"
                  />
                  <div class="home-container28">
                    ...
                    Welltech care one of the most trusted medical laboratories in terms of conducting PME services that offers accurate 
                    and detailed results by our professional doctors and deliver your results at a timely manner.
                    </span>
                  </div>
                </div>
                <div class="home-container29">
                  <div class="home-container30">
                    <div class="home-container31">
                      <h1 class="home-text043">
                        <span>Opening Hours</span>
                        <br />
                      </h1>
                      <span class="home-text046">
                      If you’re planning to come physically to our clinic be guided by our opening and closing time for each branch before visiting thank you.
                      </span>
                    </div>
                  </div>
                  <div class="home-container32">
                    <span class="home-text047">Monday - Saturday</span>
                    <span class="home-text048">9:00 am - 6:30 pm</span>
                  </div>
                  <div class="home-container33">
                    <span class="home-text049">Sunday</span>
                    <span class="home-text050">9:00 am - 7:00 pm</span>
                  </div>
                </div>
                <div class="home-container34">
                  <h1 class="home-text051">
                  ...
                  <div class="home-container35">
                    ...
                    <div class="home-container37">
                      <span class="home-text054">
                      391 F. Roxas Grace Park West, Manila Metro Manila Building
                      </span>
                    </div>
                  </div>
                  <div class="home-container38">
                    ...
                    <span class="home-text055">+63 912-456-9716</span>
                  </div>
                  <div class="home-container39">
                    ...
                    <span class="home-text056">welltechcare@gmail.com</span>
                  </div>
                  <div class="home-container40">
                    ...
                    <span class="home-text057">www.welltechcare.com</span>
                  </div>
                </div>
              </div>
        ...
        <div class="home-container43">
          ...
          Start your medical appointment by creating your account through our website just click here.
          </span>
          <a href="registration.php" class="home-navlink01 button">
            Register Here
          </a>
        </div>
          ...
          <div class="home-hero">
            <div class="home-container45">
              <div class="home-container46">
                <h1 class="home-text059">
                  <span class="home-text060">Need an immediate</span>
                  <br />
                ...
                <span class="home-text064">
                  <span>
                  Create an account to our website by clicking the register here above and fill in the details so you can schedule an appointment at your preferred available date 
                  and time and choose your specific professional doctor that is available on our list.
                  </span>
                  <br />
                  <br />
                  <span>
                  After your medical consultation please be guided that there will be a processing time in which the results need time to get processed correctly and will be sent to your account and 
                  please be guided by the opening hours and if you have any inquiries or questions feel free to drop a message or email us at our corresponding email given below.
                  </span>
                  <span></span>
                  <span></span>
                </span>
                <a href ="Patient/login-patient.php">
            ...
            <div class="home-container47">
              <div class="home-container48">
                <span class="home-text071">
                  ...
                  <span class="home-text073">appointment toDay!</span>
                </span>
              </div>
              <span class="home-text074">
                <span>
                WellTech care offers only the best professional doctors so what are you waiting for.
                </span>
                <br />
              </span>
              <a href ="Patient/login-patient.php">
              <button class="home-button1 button">Find a Doctor</button>
    </a>
            </div>
          </div>
        </div>
            ...
            <div class="home-container50">
              <div class="home-container51">
                ...
                <div class="home-container52">
                  <span class="home-logo-text2">WellTech Care</span>
                  <span class="home-text077">Physical &amp; Health Care</span>
                </div>
                <div class="home-container53"></div>
              </div>
              ...
              <div class="home-container55">
                <div class="home-container56">
                  <span class="home-text082">
                    <span class="home-text083">QUICK&nbsp;&nbsp;</span>
                    <span class="home-text084">LINKS</span>
                  </span>
                  <a href="index.php" class="home-navlink02">
                    <span>Home</span>
                    <br />
                  </a>
                  <a href="about-us.php" class="home-navlink03">About Us</a>
                  <a href="news.php" class="home-navlink04">News</a>
                  <a href="contact-us.php" class="home-navlink05">Location</a>
                </div>
                <div class="home-container57">
                  <span class="home-text087">
                    <span class="home-text088">CONTACT&nbsp;&nbsp;</span>
                    <span class="home-text089">US</span>
                  </span>
                  <div class="home-container58">
                    ...
                    <span class="home-text090">Address here</span>
                  </div>
                  <div class="home-container59">
                    ...
                    <div class="home-container60">
                      <span class="home-text091">www.welltechcare.com</span>
                    </div>
                  </div>
                  <div class="home-container61">
                    ...
                    <span class="home-text092">+63 912-456-9716</span>
                  </div>
                  <div class="home-container62">
                    ...
                    <div class="home-container63">
                      <span class="home-text093">welltechcare@gmail.com</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="home-container64">
                <div class="home-container65">
                  <span class="home-text094">
                    <span class="home-text095">WORKING&nbsp;&nbsp;</span>
                    <span class="home-text096">HOURS</span>
                  </span>
          ...
          <footer class="home-footer1">
            ...
            <div class="home-container67">
              <div class="home-container68">
                <a href="index.php" class="home-navlink06">Home</a>
                <a href="about-us.php" class="home-navlink07">About Us</a>
                <a href="news.php" class="home-navlink08">News</a>
                <a href="contact-us.php" class="home-navlink09">Contact Us</a>
              </div>
            </div>
          </footer>
        </div>
