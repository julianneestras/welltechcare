...
include 'Function/SearchUploadResult.php';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <meta
      property="og:title"
      content="Upload-Lab-Results-Admin - Copy of WellTech Care"
    />
  ...
  <body>
    <div>
      <link href="./upload-lab-results-admin.css" rel="stylesheet" />

      <div class="upload-lab-results-admin-container">
        <div class="upload-lab-results-admin-admin-upload-results-container">
          <div class="upload-lab-results-admin-sidebar">
            <div class="upload-lab-results-admin-logo-container">
              <img
                alt="image"
                src="public/playground_assets/logo-200h.png"
                class="upload-lab-results-admin-image"
              />
              <div class="upload-lab-results-admin-container01">
                <span class="upload-lab-results-admin-logo-text">
                  WellTech Care
                </span>
                <span class="upload-lab-results-admin-text">
                  Physical &amp; Health Care
                </span>
              </div>
              <svg
                viewBox="0 0 1024 1024"
                class="upload-lab-results-admin-icon"
              >
                <path
            ...
            <nav class="upload-lab-results-admin-nav">
              <a
                href="admin-portal-home.php"
                class="upload-lab-results-admin-navlink"
              >
                <div class="upload-lab-results-admin-container02">
                  <svg
                    viewBox="0 0 1024 1024"
                    class="upload-lab-results-admin-icon02"
                  >
                    <path
                  ...
                  <span class="upload-lab-results-admin-text01">Dashboard</span>
                </div>
              </a>
              <div class="upload-lab-results-admin-container03">
                <a
                  href="manage-appointments-admin.php"
                  class="upload-lab-results-admin-navlink1"
                >
                  <div class="upload-lab-results-admin-container04">
                    <svg
                      viewBox="0 0 950.8571428571428 1024"
                      class="upload-lab-results-admin-icon04"
                    >
                      <path
                    ...
                    <span class="upload-lab-results-admin-text02">
                      Manage Appointments
                    </span>
                  </div>
                </a>
                <a
                  ...
                  class="upload-lab-results-admin-navlink2"
                >
                  <div class="upload-lab-results-admin-container05">
                    <svg
                      viewBox="0 0 1024 1024"
                      class="upload-lab-results-admin-icon06"
                    >
                      <path
                    ...
                    <span class="upload-lab-results-admin-text03">
                      Manage Doctors
                    </span>
                  </div>
                </a>
              ...
              <a
                ...
                class="upload-lab-results-admin-navlink3"
              >
                <div class="upload-lab-results-admin-upload-lab-results">
                  <svg
                    viewBox="0 0 1024 1024"
                    class="upload-lab-results-admin-icon08"
                  >
                    <path
                  ...
                  <span class="upload-lab-results-admin-text04">
              ...
              <div class="upload-lab-results-admin-profile">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  class="upload-lab-results-admin-icon10"
                >
                  <path
                ...
                <span class="upload-lab-results-admin-text07">
                  <span>Profile</span>
                  <br />
                </span>
              </div>
              ...
              <a
                ...
                class="upload-lab-results-admin-navlink4 logout"
              >
                <div class="upload-lab-results-admin-logout">
                  <div class="upload-lab-results-admin-container06">
                    <svg
                      viewBox="0 0 1024 1024"
                      class="upload-lab-results-admin-icon12"
                    >
                      <path
                  ...
                  <div class="upload-lab-results-admin-container07">
                    <span class="upload-lab-results-admin-text10">
                      <span>Logout</span>
                      <br />
                    </span>
                  </div>
            ...
            <div class="upload-lab-results-admin-profile1">
              <?php echo '<img src="data:image;base64,'.base64_encode( $admin_picture ).'"class="upload-lab-results-admin-image1"
                         />';?>
              <div class="upload-lab-results-admin-container08">
                <span class="upload-lab-results-admin-text13">
                  <?php echo $admin_firstname?>
                </span>
                <span class="upload-lab-results-admin-text14">Admin</span>
              </div>
            </div>
          </div>
          <div class="upload-lab-results-admin-main-body-container">
            <div class="upload-lab-results-admin-header-container">
              <span class="upload-lab-results-admin-patient-portal-txt">
                Admin Portal System&nbsp;
              </span>
              <div class="upload-lab-results-admin-icons-container">
                <img
                  alt="image"
                  src="public/playground_assets/search-200h.png"
                  class="upload-lab-results-admin-image2"
                />
                <a
                  href="manage-appointments-admin.php"
                  class="upload-lab-results-admin-navlink5"
                >
                  <img
                    alt="image"
                    src="public/playground_assets/plus%20%5B4%5D-200h.png"
                    class="upload-lab-results-admin-image3"
                  />
                </a>
                <img
                  alt="image"
                  src="public/playground_assets/bell%20%5B2%5D-200h.png"
                  class="upload-lab-results-admin-image4"
                />
              </div>
            </div>
            <div class="upload-lab-results-admin-container09">
              <div class="upload-lab-results-admin-container10">
                <div class="upload-lab-results-admin-container11">
                  <div
                    class="upload-lab-results-admin-admin-upload-results-form-container"
                  >
                    <div class="upload-lab-results-admin-container12">
                      <span
                        class="upload-lab-results-admin-cnfrm-appointment-txt"
                      >
                        List of Patients
                      </span>
                    </div>
                    <form method="POST">
                    <div class="upload-lab-results-admin-container13">
                      <input
                        name="search"
                        type="submit"
                        class="upload-lab-results-admin-srch-btn button"
                        style="margin-top: 27px; margin-right: 8px;" value="Search">
                        
                      <input
                        type="text"
                        name="SearchHistory"
                        placeholder="Search here..."
                        class="upload-lab-results-admin-textinput input"
                      />
                    </div>
                  </form>
                                  ...
                                  <td>
                                      <table style="border-collapse: collapse; width: 100%;">
                                          ...
                                          <tr style="background-color: #0C234B;">
                                              <td style="padding: 16px; font-size: 14px; color: #F2F2F2; font-family: 'Exo 2', sans-serif; font-weight: 600;">PatientID</td>
                                              <td width=""
                                          ...
                                          $stmt = $conn->prepare("SELECT * FROM appointments WHERE appointment_status='Result Uploaded' OR appointment_status='Result Sent'");
                                          $stmt->execute();
                                        ...
                                        ?> 
                                          <tr style="border-top: 1px solid #CED5E0;">
                                              <td width="10%" style="padding-left: 20px; padding-right: 20px; padding-top: 10px;  padding-bottom: 10px;">
                                                  <font style="font-family: 'Inter', sans-serif; font-size: 13px; color: #4C5A7A; line-height: 2; letter-spacing: -1px"><?= $row['Patient_ID'] ?>
                                                  </font>
                                              </td>
                                              ...
                                              <td align="center" width="10%">
                                                  <a href="expanded-lab-results-admin.php?Patient-ID=<?= $row['Patient_ID'] ?>&Appointment-ID=<?= $row['appointment_id'] ?>" class="button">
                                                      <svg width="18px" height="18px" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet"
                                                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="svgcolor">
